...
export interface Claim { id: string; type: ClaimType; title: string; description: string; incidentAt: string; lossAmount: number; currency: string; agentIdentifier?: string; referenceId?: string; policyId?: string; status: ClaimStatus; createdAt: string; updatedAt?: string; claimHash?: string; evidence?: Evidence[]; adjudication?: Transaction; verdict?: Verdict; }
