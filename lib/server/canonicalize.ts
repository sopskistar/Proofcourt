...
type CanonicalClaim = { version: 1; claim: { agentIdentifier: string; currency: string; description: string; incidentAt: string; incidentCategory: string; lossAmount: string; policyId: string; referenceId: string; title: string; type: string }; evidence: { hash: string; mimeType: string; size: number }[] };
