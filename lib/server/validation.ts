...
export function validateDraft(value: unknown): ClaimDraft {
  ...
  return { type, title: text("title", 120, true), description: text("description", 4000, true), incidentAt, lossAmount, currency, agentIdentifier: text("agentIdentifier", 200), referenceId: text("referenceId", 200), policyId: text("policyId", 200) };
}
